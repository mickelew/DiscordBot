#Webscraper
$request = Invoke-WebRequest -ContentType "application/json; charset=utf-8" -Uri 'https://www.matchi.se/book/schedule?wl=&facilityId=526&date=2021-05-07&sport=5&week=&year=&_=' -UseBasicParsing
...
$content = $regexReplace2 | Select-Object -Index 5
$payload = [PSCustomObject]@{ 
    content = $content
}
Write-Output $regexReplace2 
Invoke-RestMethod -Uri $hookUrl -Method Post -ContentType 'Application/Json; charset=utf-8' -Body ($payload | ConvertTo-Json)